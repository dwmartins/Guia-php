...
class EmailConfigDAO extends Database{
    public static function save(EmailConfig $emailConfig): int {
        try {
            ...
            throw new Exception("Error when executing query to save email settings: " . $e);
        }
    }
    ...
    public static function update(EmailConfig $emailConfig): int {
        try {
            ...
            throw new Exception("Error when executing query to update email settings: ". $e);
        }
    }
    ...
    public static function fetch(): array {
        try {
            ...
            throw new Exception("Error when executing query to search for email settings: " . $e);
        }
    }
}
